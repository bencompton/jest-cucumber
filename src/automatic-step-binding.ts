...
import { createDefineFeature, type StepsDefinitionCallbackFunctionWithContext } from './feature-definition-creation';
...
export const createAutoBindSteps = () => {
  const defineFeature = createDefineFeature();
